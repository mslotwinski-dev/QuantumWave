...
def get_potential(name, x, E_kinetyczna, p):
    ...
    if name == 'brak': 
        ...
        raise ValueError(f"Nieznany typ potencjału: {name}. Dostępne opcje: 'brak', 'bariera A', 'skok', 'spadek', 'bariera', 'bariera nieskonczona', 'studnia', 'studnia nieskonczona', 'trololololo'")
